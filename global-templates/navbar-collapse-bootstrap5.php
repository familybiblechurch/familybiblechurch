...
<nav id="main-nav" class="navbar navbar-expand-md fixed-top navbar-dark nav-bg" aria-labelledby="main-nav-label">
	...
	<div class="<?php echo esc_attr( $container ); ?>">
		...
		<?php if ( ! has_custom_logo() ) { ?>
			...
			<?php if ( is_front_page() && is_home() ) : ?>
				...
				<h1 class="navbar-brand mb-0"><a rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>" itemprop="url">Family Bible Church | <span class="brand-sub">Knoxville</span></a></h1>
